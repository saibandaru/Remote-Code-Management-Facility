...
*
*void start()											starts sender and receiver modules for client
*
*  Required Files:
*  ---------------
...
*  Maintenance History:
*  --------------------
*  Version 2.0 April 27
*/


#include "../sockets/sockets.h"
//#include "../CppCli-WPF-App/Window.h"
...
{
public:
	Client(std::string addressI, std::string pathI)
	{
	...
	void sender();
	bool connectadd(SocketConnecter&, std::string, int);
	void receiver();
